...
def sentence_generator(word: str, num_sentences=3):
    try:
        ...
        for _ in range(num_sentences):
            result = gpt2_generator(word, do_sample=True, top_k=50, temperature=0.7, max_length=20, num_return_sequences=1, pad_token_id=50256, truncation=True)
