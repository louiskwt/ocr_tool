...
def validate_word(word: str) -> bool:
    ...
    stopwords = [
        ...
        "same", "so", "than", "too", "very", "yet", "one", "two", "three", "four", "five",
        "six", "seven", "eight", "nine", "ten", "yip", "unless", "word", "number",
        ...
        "can", "could", "may", "might", "must", "ought", "’s", "n’t", "'re", " ", 
        "cc", "ca", "'re", "iii", "anti", "non"]
